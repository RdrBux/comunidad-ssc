	...
	return (
		<div>
			...
			<main className="container mx-auto px-4 lg:px-16 py-24 text-neutral-950">
				<article className="">
					<a className="group relative p-8 lg:p-16 flex flex-col rounded-md overflow-hidden min-h-[480px]" href="blog/posts/1">
				...
				<div className="mt-16 grid lg:grid-cols-3 gap-16">
					<div className="lg:col-span-2 grid gap-x-8 gap-y-12 lg:gap-y-16 lg:grid-cols-2">
						...
						<article className="flex flex-col gap-3">
							<a href="#"><img className="hover:brightness-75 duration-300 rounded h-full w-full object-cover object-center aspect-[3/2]" src="https://images.unsplash.com/photo-1491438590914-bc09fcaaf77a?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" /></a>
						...
						<article className="flex flex-col gap-3">
							<a href="#"><img className="hover:brightness-75 duration-300 rounded-md h-full w-full object-cover object-center aspect-[3/2]" src="https://images.unsplash.com/photo-1443926818681-717d074a57af?q=80&w=1480&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" /></a>
							<div className="text-sm text-neutral-600 font-medium">Por <a href="#" className="text-neutral-950 font-semibold hover:text-secondary-700 duration-300">Saber Supercomplejo</a> <span className="hidden lg:inline">•</span><br className="lg:hidden" /> 16 de julio de 2022</div>
							<a className="hover:text-neutral-700 duration-300" href="#"><h3 className="font-semibold text-2xl tracking-tighter leading-tight">Título del Post: Continuación del Título</h3></a>
							<div className="flex gap-2 text-neutral-600">
								<div className="bg-neutral-200 p-2 rounded text-sm font-medium">Educación</div>
						...
						<article className="flex flex-col gap-3">
							<a href="#"><img className="hover:brightness-75 duration-300 rounded-md h-full w-full object-cover object-center aspect-[3/2]" src="https://images.unsplash.com/photo-1491438590914-bc09fcaaf77a?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" /></a>
							<div className="text-sm text-neutral-600 font-medium">Por <a href="#" className="text-neutral-950 font-semibold hover:text-secondary-700 duration-300">Saber Supercomplejo</a> <span className="hidden lg:inline">•</span><br className="lg:hidden" /> 16 de julio de 2022</div>
							<a className="hover:text-neutral-700 duration-300" href="#"><h3 className="font-semibold text-2xl tracking-tighter leading-tight">Título del Post: Continuación del Título</h3></a>
							<div className="flex gap-2 text-neutral-600">
								<div className="bg-neutral-200 p-2 rounded text-sm font-medium">Educación</div>
					...
					<div className="flex flex-col gap-10">
						<div className="rounded-md p-8 bg-neutral-200/60">
