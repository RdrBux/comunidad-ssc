			...
			<main className="container mx-auto px-4 lg:px-16 py-24 text-neutral-950">
				...
				<div className="mt-16 grid lg:grid-cols-3 gap-16">
					...
					<div className="flex flex-col gap-10">
						<div className="rounded-xl p-8 bg-neutral-200/50">
							<div className="w-[260px] lg:w-[220px]"><FullLogo /></div>
							<p className="mt-6">Bienvenido blabla ipsum dolor sit amet consectetur adipisicing elit. Omnis similique consectetur ipsam qui velit ratione facilis deleniti aperiam dolores recusandae.</p>
