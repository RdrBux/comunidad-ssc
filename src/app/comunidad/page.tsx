		...
		<>
			<ContentLayout>
				...
				<div className="mt-16">
					...
					<p className="mt-8">Esta propuesta surge luego de años de trabajo y estudio movida por la inquietud de ofrecer una teoría integradora y superadora del Pensamiento Complejo, las Ciencias de la Complejidad y otros enfoques relacionados que permita, además de un desarrollo teórico, su aplicación práctica y metodológica.</p>
