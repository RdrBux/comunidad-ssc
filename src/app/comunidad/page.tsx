	...
	return (
		<>
			<ContentLayout>
				...
				<div className="mt-16">
					<h3 className="text-3xl font-bold tracking-tight text-neutral-950">Quiénes somos</h3>
					...
					<h4 className="mt-12 text-2xl font-bold tracking-tight text-neutral-950">Misión</h4>
					...
					<h4 className="mt-12 text-2xl font-bold tracking-tight text-neutral-950">Visión</h4>
					...
					<h4 className="mt-12 text-2xl font-bold tracking-tight text-neutral-950">Valores</h4>
					...
					<h4 className="mt-12 text-2xl font-bold tracking-tight text-neutral-950">Qué Ofrecemos a Nuestros Miembros</h4>
					<ul className="list-disc flex flex-col gap-2 mt-4 pl-6">
					...
					<h4 className="mt-12 text-2xl font-bold tracking-tight text-neutral-950">Qué Ofrecemos a Instituciones</h4>
					<ul className="list-disc flex flex-col gap-2 mt-4 pl-6">
