			...
			<ContentLayout>
				<div className="grid relative mt-4">
					...
					<div className="lg:py-20 lg:-order-1 w-fit">
						<h1 className="font-medium text-sm lg:text-base">EL CAMINO</h1>
						<h2 className={`font-source text-4xl text-neutral-950 lg:text-6xl tracking-tight font-semibold mt-2`}>¿Qué acciones permiten que nuestros proyectos, nuestra comunidad y sus miembros crezcan?</h2>
					</div>
				...
				<div className="mt-24 lg:mt-12 flex flex-col gap-4">
					...
					<h4 className={`font-source mt-6 text-2xl text-neutral-950 font-bold`}>Julio del 2024</h4>
					...
					<h4 className={`font-source mt-6 text-2xl text-neutral-950 font-bold`}>Octubre del 2024</h4>
					...
					<h4 className={`font-source mt-6 text-2xl text-neutral-950 font-bold`}>Noviembre del 2024</h4>
					...
					<h4 className={`font-source mt-6 text-2xl text-neutral-950 font-bold`}>Diciembre del 2024</h4>
