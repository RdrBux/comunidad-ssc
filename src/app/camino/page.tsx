		...
		<>
			<ContentLayout>
				...
				<div className="mt-24 lg:mt-12 flex flex-col gap-4">
					...
					<h4 className="mt-8 text-xl font-semibold">Diciembre del 2024</h4>
			...
			<NextRead>
				...
				<div className="mt-4 flex gap-4">
					<Link className="w-fit text-lg mt-4 block px-4 py-2 border rounded-full border-neutral-950 hover:bg-neutral-950 hover:text-secondary-300 duration-300" href="/teoria">La Teoría</Link>
					<Link className="w-fit text-lg mt-4 block px-4 py-2 border rounded-full border-neutral-950 hover:bg-neutral-950 hover:text-secondary-300 duration-300" href="/actores">Los Actores</Link>
				</div>
			</NextRead>
