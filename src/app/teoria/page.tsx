			...
			<ContentLayout>
				<div className="grid relative">
					...
					<div className="py-12 lg:py-20 lg:-order-1 w-fit">
						<h1 className="font-medium text-sm lg:text-base">LA TEORÍA</h1>
						<h2 className={`font-source text-5xl lg:text-6xl text-neutral-950 tracking-tight font-semibold mt-2`}>¿Qué es el Saber Supercomplejo?</h2>
					</div>
				...
				<div className="lg:mt-16">
					...
					<h3 className={`font-source mt-12 text-4xl font-bold tracking-tight text-neutral-950`}>Nuestra propuesta: El Saber Supercomplejo (SSC)</h3>
					...
					<h4 className={`font-source mt-12 text-3xl font-bold tracking-tight text-neutral-950`}>Objeto de estudio</h4>
					...
					<div className="mt-12">
						<h4 className={`font-source text-3xl font-bold tracking-tight text-neutral-950`}>Ejes de la propuesta del Saber Supercomplejo</h4>
