	...
	return (
		...
		<section className="bg-neutral-950 text-tertiary-50">
			<div className="container mx-auto px-4 lg:px-16 py-16">
				<div className="grid lg:grid-cols-3 border-2 rounded border-neutral-900">
					...
					<div className="p-8 xl:px-12 flex flex-col gap-8 justify-evenly">
						...
						<ul className="hidden lg:flex gap-2">
							<li>
								<a title="Instagram" className="border-2 rounded border-neutral-900 p-2 grid place-content-center w-fit group" aria-label="Instagram" href="http://www.instagram.com/comunidad.ssc" target="_blank" rel="noopener noreferrer">
							...
							<li>
								<a title="Facebook" className="border-2 rounded border-neutral-900 p-2 grid place-content-center w-fit group" aria-label="Facebook" href="http://www.facebook.com/comunidad.ssc" target="_blank" rel="noopener noreferrer">
									<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-facebook group-hover:text-secondary-500 duration-300"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>
								</a>
							</li>

							<li>
								<a title="LinkedIn" className="border-2 rounded border-neutral-900 p-2 grid place-content-center w-fit group" aria-label="LinkedIn" href="http://www.linkedin.com/comunidad.ssc" target="_blank" rel="noopener noreferrer">
									<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-linkedin group-hover:text-secondary-500 duration-300"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" /><rect width="4" height="12" x="2" y="9" /><circle cx="4" cy="4" r="2" /></svg>
								</a>
							</li>
						</ul>
					</div>
