				...
				<div className="grid lg:grid-cols-3 border-2 rounded border-neutral-900">
					...
					<div className="p-8 xl:px-12 flex flex-col gap-8 justify-evenly">
						...
						<ul className="hidden lg:flex gap-2">
							<li>
								<a title="Instagram" className="border-2 rounded border-neutral-900 p-2 grid place-content-center w-fit group" aria-label="Instagram" href={MEDIA.INSTAGRAM} target="_blank" rel="noopener noreferrer">
							...
							<li>
								<a title="Facebook" className="border-2 rounded border-neutral-900 p-2 grid place-content-center w-fit group" aria-label="Facebook" href={MEDIA.FACEBOOK} target="_blank" rel="noopener noreferrer">
							...
							<li>
								<a title="LinkedIn" className="border-2 rounded border-neutral-900 p-2 grid place-content-center w-fit group" aria-label="LinkedIn" href={MEDIA.LINKEDIN} target="_blank" rel="noopener noreferrer">
